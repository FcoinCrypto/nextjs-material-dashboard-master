...
import routeMarchands from "../routeMarchand";
...
export default function marchand({ children, ...rest }) {
  ...
  const getRoute = () => {
    return router.pathname !== "/marchand/maps";
  };
